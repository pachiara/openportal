module Themes::Openportal::MainHelper
  ...
  def openportal_on_install_theme(theme)
    ...
    group.add_field({"name"=>"Column Right", "slug"=>"icon_section_right"}, {field_key: "editor", translate: true, default_value: "La condivisione è un potente mezzo per aumentare la sicurezza delle applicazioni."})
